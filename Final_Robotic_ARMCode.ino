...
const int servo_joint_L_parking_pos = 60; //10
const int servo_joint_R_parking_pos = 60; //10
...
int servo_joint_L_pos_increment = 2;
int servo_joint_R_pos_increment = 2;
int servo_joint_1_pos_increment = 2;
int servo_joint_2_pos_increment = 2;
int servo_joint_3_pos_increment = 10;
int servo_joint_4_pos_increment = 5;
